      ...
      {success ? (
        <div className="text-center py-10 space-y-4">
          ...
          <button
            ...
            className="px-6 py-2 rounded-full text-xs font-black uppercase text-white hover:brightness-110 transition-all mt-4"
          >
            Enviar otro mensaje
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div className="bg-red-50 border border-red-100 text-red-600 p-4 rounded-2xl text-xs flex items-center gap-2">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-[var(--primary-club)] focus:bg-white transition-all"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-[var(--primary-club)] focus:bg-white transition-all resize-none"
          ...
          <div className="pt-2 text-right">
            <button
              ...
              disabled={submitting}
              style={{ backgroundColor: primaryColor }}
              className="inline-flex items-center justify-center px-6 py-3 rounded-full text-xs font-black uppercase tracking-wider text-white hover:brightness-110 disabled:opacity-50 transition-all shadow-md shadow-[var(--primary-club)]/15"
            >
